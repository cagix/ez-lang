...
public interface ASTVisitor {
    ...
    ASTVisitor visit(AST.GetFieldExpr fieldExpr, boolean enter);
    ASTVisitor visit(AST.SetFieldExpr fieldExpr, boolean enter);
    ...
    ASTVisitor visit(AST.ArrayLoadExpr arrayLoadExpr, boolean enter);
    ASTVisitor visit(AST.ArrayStoreExpr arrayStoreExpr, boolean enter);
    ASTVisitor visit(AST.NewExpr newExpr, boolean enter);
    ASTVisitor visit(AST.InitExpr initExpr, boolean enter);
